document.addEventListener('DOMContentLoaded', () => {
  ...
  formVenda.addEventListener('submit', async e => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        form.submit(); // envia para o Google Sheets
      } else {
  ...
  // suas funções MenuPedidos e sair podem ficar aqui, se precisar
  window.MenuPedidos = function () {
    const man = document.getElementById('caixadepedidos');
    man.style.marginTop = '125%';
  };

  window.sair = function () {
    const ss = document.getElementById('caixadepedidos');
